...
class EnhancedRetrievalTools:
    ...
    async def _scrape_url_enhanced(self, url: str) -> Dict:
        ...
        async with async_playwright() as p:
            try:
                ...
                cleaned_text = self._clean_scraped_text(content_data['text'])
    ...
    def scrape_with_playwright(self, url: str) -> str:
        ...
        try:
            ...
            result = asyncio.run(self._scrape_url_enhanced(url))
...
def scrape_with_playwright(url: str) -> str:
    """Backward compatible function."""
    return enhanced_retrieval.scrape_with_playwright(url)
